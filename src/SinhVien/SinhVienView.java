...
public class SinhVienView extends javax.swing.JFrame {
    ...
    public SinhVienView() {
        ...
        list.add(new SinhVIen("Ho", 9.5));
        list.add(new SinhVIen("HoA", 9.5));
        list.add(new SinhVIen("HoV", 9.5));
        list.add(new SinhVIen("HoC", 9.5));

        for (SinhVIen sinhVIen : list) {
            cboTen.addItem(sinhVIen.getTen());
        }
    }
    ...
    private void btnChonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnChonMouseClicked
        ...
        String ten = (String) cboTen.getSelectedItem();
        for (SinhVIen sinhVIen : list) {
